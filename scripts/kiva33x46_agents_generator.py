...
agent_num = 180
num_queries_to_gen = 7000
# agent_fname_prefix = (map_fname[:-4] + "map-" + str(agent_num) + "agents-t")
# todo add t for test set ===================================================================
agent_fname_prefix = (folder_name + str(agent_num) + "agents/"+map_fname[len(folder_name):-4]+"map-"+str(agent_num)+"agents-")  # todo EDB
