...
public:
	...
	ICBSSearch(const MapLoader& ml, const AgentsLoader& al, double f_w, const EgraphReader& egr, constraint_strategy c, bool prior_branching = false, bool trans_prior = false);
	~ICBSSearch();
};
