...
public:
	...
	*/
	...
	bool findPath(vector<PathEntry> &path, double f_weight, const vector < list< tuple<int, int, bool> > >* constraints, const bool* res_table, size_t max_plan_len, double lowerbound);
