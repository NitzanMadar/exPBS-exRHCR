...
//ICBSNode::ICBSNode(int agent_id, int numAgents, double g_val, double num_of_collisions, int time_expanded, double sum_min_f_vals)
//{
...
/*ICBSNode::ICBSNode(int agent_id, ICBSNode* parent, double g_val, double num_of_collisions, int time_expanded, double sum_min_f_vals)
	:parent(parent)
{
	this->agent_id = agent_id;
	this->g_val = g_val;
